...
from argus.db import FileManager, RepositoryManager, SnippetManager
from argus.dtos import CreateRepositoryDto
from argus.dtos.create_dtos import CreateFileDto, CreateSnippetDto
from argus.parsers import CodeChunker
...
class CodeProcessor:
    ...
    def run(self) -> None:
        ...
        for file_path in tqdm(self._get_files(), desc="Parsing files", leave=True):
            ...
            except Exception as e:  # noqa: BLE001 -- one malformed file must not abort the corpus
            ...
            try:
                ...
                for chunk in chunks.values():
                    ...
                    except Exception as e2:  # noqa: BLE001 -- continue processing after one failed insert
