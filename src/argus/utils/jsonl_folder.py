...
class JsonlFolder:
    ...
    def __init__(self, folder: str | Path, recursive: bool = False):
    ...
    def _read_jsonl(self, path: str | Path) -> Iterator[dict]:
                ...
                try:
                    ...
                    for item in payload:
                        try:
                            ...
                            continue
            except Exception as e:  # noqa: BLE001 -- malformed external output is skipped at this boundary
