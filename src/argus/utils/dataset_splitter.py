...
from argus.cluster import Embedder
from argus.configs.logging_config import get_logger
from argus.db import EmbeddingsManager, FunctionalityManager, RepositoryManager
...
class DatasetSplitter:
    ...
    def embed_all_repositories(self) -> None:
        ...
        try:
            ...
            logger.exception("Failed to embed repository functionalities", error=str(e))
    ...
    def split_repositories(self, train_size: float, test_size: float) -> None:
        ...
        try:
            ...
            logger.exception("Failed to split repositories", error=str(e))
