...
class Normalizer:
    ...
    def __init__(self, model_name: str = "en_core_web_sm") -> None:
        ...
        try:
            ...
            logger.exception("Failed to initialize NLP model", model_name=model_name)
    ...
    def normalize_text(self, text: str) -> str:
        ...
        tokens = [token.lemma_ for token in doc if not token.is_stop and not token.is_punct and token.pos_ in self.keep_pos]
