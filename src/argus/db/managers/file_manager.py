...
from argus.db.models import FileModel
from argus.dtos import CreateFileDto, UpdateFileDto
from argus.entities import File
...
class FileManager:
    ...
    def update_file(self, file: UpdateFileDto) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to update file {file.file_id}")
