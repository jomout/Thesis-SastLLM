...
from argus.dtos import CreateRepositoryDto, UpdateRepositoryDto
from argus.entities import FunctionalityWithCluster, Repository, RepositoryWithClusterDistribution
...
class RepositoryManager:
    ...
    def get_repositories(self, split: Literal["train", "test"] | None = None, batch_size: int = 100) -> Iterator[Repository]:
        """
    ...
    def delete_repository(self, repository_id: int) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to delete repository {repository_id}")
    ...
    def update_repository(self, repository: UpdateRepositoryDto) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to update repository {repository.repository_id}")
    ...
    def bulk_update_split(self, repo_ids: list[int], split: str) -> None:
        ...
        try:
            ...
            logger.exception("Failed bulk update split")
