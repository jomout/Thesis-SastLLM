...
from argus.db.models import FileModel, SnippetModel
from argus.dtos import CreateSnippetDto, UpdateSnippetDto
from argus.entities import Snippet, SnippetWithFileAndRepository
...
class SnippetManager:
    ...
    def add_bulk_snippets(self, snippets: list[CreateSnippetDto]) -> list[int]:
        ...
        try:
            ...
            logger.exception("Failed to add bulk snippets")
    ...
    def delete_snippet(self, snippet_id: int) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to delete snippet {snippet_id}")
    ...
    def update_snippet(self, snippet: UpdateSnippetDto) -> None:
        ...
        try:
            ...
            logger.exception(f"Failed to update snippet {snippet.snippet_id}")
    ...
    def update_bulk_snippets(self, snippets: list[UpdateSnippetDto]) -> None:
        ...
        try:
            ...
            logger.exception("Failed to update bulk snippets")
