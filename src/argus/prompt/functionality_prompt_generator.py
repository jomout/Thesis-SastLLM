...
class FunctionalityPromptGenerator:
    ...
    CONTROL_NODES = frozenset({"if_statement", "for_statement", "while_statement", "switch_statement", "match_statement"})
    STRING_NODE_TYPES = frozenset({"string", "string_literal"})
    CALL_EXPR_TYPES = frozenset({"call_expression", "call"})
